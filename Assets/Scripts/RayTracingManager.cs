...
public class RayTracingManager : MonoBehaviour
{
	...
	public void SetRayTracingEnabled(bool isEnabled)
	{
		enableRayTracing = isEnabled;
	}
	...
	void OnRenderImage(RenderTexture src, RenderTexture target)
	{
		if (!enableRayTracing)
		{
			Graphics.Blit(src, target); // Si el ray tracing está deshabilitado, simplemente renderiza la imagen sin alteraciones
			return;
		}
